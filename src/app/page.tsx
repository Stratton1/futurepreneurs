            ...
            {[
              {
                ...
                description:
                  "Tell the world about your business idea. Set a funding goal and plan your milestones.",
              ...
              },
              {
                ...
                title: "Get verified",
                description:
                  "Your teacher checks your project and your parent gives the green light.",
              ...
              },
              {
                ...
                title: "Get funded",
                description:
                  "Share your project and watch the support roll in from backers who believe in you.",
              ...
              },
              {
                ...
                description:
                  "Hit your milestones and draw down funds with your teacher's approval. You're an entrepreneur!",
                color: "bg-purple-100 text-purple-700",
              },
            ].map((item) => (
              <div key={item.step} className="text-center">
                <div
                  className={`${item.color} w-12 h-12 rounded-2xl flex items-center justify-center text-xl font-bold mx-auto mb-4`}
                >
                  {item.step}
                </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We&apos;ve built safety into every step, so young people can
              focus on their ideas while adults have peace of mind.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Students sign up with their school email. Every project is
                verified by a teacher before going live.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Every student picks a teacher as their mentor. The teacher
                approves how funds are spent, step by step.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Parents give consent and can see everything — funding
                progress, milestones, and how money is being spent.
              </p>
            </div>
          </div>
        </div>
